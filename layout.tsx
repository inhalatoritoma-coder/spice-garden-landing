...
:root {
  /* Spice Garden Luxurious Theme - Deep jewel tones */
  ...
  --chart-2: oklch(0.35 0.12 20);
  --chart-3: oklch(0.40 0.08 200);
...
.dark {
  ...
  --border: oklch(0.25 0.02 30);
  --input: oklch(0.25 0.02 30);
  --ring: oklch(0.72 0.16 75);
  --chart-1: oklch(0.72 0.16 75);
  --chart-2: oklch(0.45 0.12 20);
